...
def dfs_schedule(courses, index, courses_to_sections, current_schedule, found_schedules):
    ...
    for sec in sections:
        ...
        dfs_schedule(courses, index + 1, courses_to_sections, current_schedule, found_schedules)
        # backtrack!
